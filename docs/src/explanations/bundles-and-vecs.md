...
You can create literal Bundles using the experimental [Bundle Literals](https://github.com/chipsalliance/chisel/blob/main/docs/src/appendix/experimental-features.md#bundle-literals) feature.
...
[Function Constructor](https://github.com/chipsalliance/chisel/blob/main/docs/src/explanations/functional-module-creation.md).
